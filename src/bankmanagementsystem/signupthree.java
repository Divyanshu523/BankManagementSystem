...
public class signupthree extends JFrame implements ActionListener{
    ...
    signupthree( String formno){
        ...
        c7=new JCheckBox("I Hereby declare taht the above entered details are correct to the best of my knowledge");
        ...
        if (ae.getSource() == submit){
            ...
            try {
                if (accounttype.equals("")){
                    JOptionPane.showMessageDialog(null,"Account tyoe is required");
                }else {
